...
import { NormalizedContact } from '../../../src/lib/ingestion/types.js';
...
describe('IdentityResolver', () => {
  ...
  describe('resolveBothContacts', () => {
    it('should resolve customer and business contacts correctly for inbound message', async () => {
      const fromContact: NormalizedContact = {
        identifier: '+1888111222',
        normalizedValue: '+1888111222',
        rawValue: '(888) 111-222',
        type: 'phone',
      ...
      const toContact: NormalizedContact = {
      ...
      const result = await IdentityResolver.resolveBothContacts(
        fromContact,
        toContact,
        'inbound'
      );
