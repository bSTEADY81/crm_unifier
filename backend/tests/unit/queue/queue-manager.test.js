...
import { QUEUE_NAMES } from '../../../src/lib/queue/types.js';
...
describe('QueueManager', () => {
    ...
    describe('error handling', () => {
        it('should throw error for non-existent queue', () => {
            expect(() => {
                queueManager.getQueue('non-existent-queue');
        ...
        it('should handle job flow creation without flow producer', async () => {
            ...
            const originalFlowProducer = queueManager.flowProducer;
            queueManager.flowProducer = null;
            const flowDefinition = {
                name: 'test-flow',
                queueName: QUEUE_NAMES.MESSAGE_PROCESSING,
                data: {}
            ...
            queueManager.flowProducer = originalFlowProducer;
        });
    });
});
