...
import { WebhookProcessor, MessageProcessor, NotificationProcessor, MaintenanceProcessor, HealthCheckProcessor } from '../../../src/lib/queue/processors.js';
...
describe('Queue Processors', () => {
    // Mock job helper
    const createMockJob = (data, jobId = 'test-job-123') => {
    ...
    describe('WebhookProcessor', () => {
        describe('processWebhook', () => {
            ...
            it('should handle processing errors', async () => {
                ...
                vi.mocked(IngestionPipeline.processMessage).mockRejectedValue(new Error('Database connection failed'));
                await expect(WebhookProcessor.processWebhook(mockJob))
            ...
            it('should include retry information in error details', async () => {
                ...
                vi.mocked(IngestionPipeline.processMessage).mockRejectedValue(new Error('Still failing'));
                try {
    ...
    describe('MessageProcessor', () => {
        describe('processMessage', () => {
            it('should process message with default options', async () => {
                ...
                expect(IngestionPipeline.processMessage).toHaveBeenCalledWith(expect.objectContaining({
                    id: 'msg_123',
                    providerId: 'gmail_test',
                    providerType: 'gmail'
                }), {
            ...
            it('should process message with custom options', async () => {
                ...
                expect(IngestionPipeline.processMessage).toHaveBeenCalledWith(expect.any(Object), {
                    skipDuplicateCheck: true,
                    skipIdentityResolution: false,
                    skipThreading: true,
                    createNewCustomers: false
